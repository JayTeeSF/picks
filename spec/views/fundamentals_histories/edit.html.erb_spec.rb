...
describe "fundamentals_histories/edit" do
  before(:each) do
  ...
  it "renders the edit fundamentals_history form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => fundamentals_histories_path(@fundamentals_history), :method => "post" do
